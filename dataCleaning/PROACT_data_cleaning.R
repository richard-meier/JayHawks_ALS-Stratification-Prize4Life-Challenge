...
### define output paths
pathToSingularDataTable = ".../singularDataTable_V05.csv"
pathToSurvivalDataTable = ".../surv_response_PROACT.txt"
pathToDummyCodedFeatureTable = ".../slope_features_dummy_coded_V05.rdata"
pathToNormallyCodedFeatureTable = ".../slope_features_default_V05.rdata"

### load data
data.allforms<-read.delim(".../corrected training data/all_forms_PROACT.txt",sep="|", header=T)
data.ALSslope<-read.delim(".../corrected training data/ALSFRS_slope_PROACT.txt",sep="|", header=T)
